...
class Settings:
    ...
    binance_tld: str = (os.getenv("BINANCE_TLD", "com") or "com").strip().lower()
    ...
    def base_endpoints(self) -> tuple[str, ...]:
        if self.binance_tld != "com":
            # Non-com tld endpoints generally use api.binance.<tld> without numeric suffix.
            return ("",)
